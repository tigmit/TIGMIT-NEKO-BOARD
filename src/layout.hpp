...
{
    {
        ...
        {KEY_TAB,            'q',          'w',     'e',     'r',     't',     'z',     'u',     'i',           'o',      'p',      '{',             '}',          '\\',     KEY_DELETE,             NC},
        {KEY_CAPS_LOCK,      'a',          's',     'd',     'f',     'g',     'h',     'j',     'k',           'l',      'o',      'a',              NC,    KEY_RETURN,             NC,KEY_RIGHT_ARROW},
        {KEY_LEFT_SHIFT,     'y',          'x',     'c',     'v',     'b',     'n',     'm',     ',',           '.',      '-',       NC, KEY_RIGHT_SHIFT,            NC,             NC,   KEY_UP_ARROW},
